...
class _WindowSettingsEditorState extends State<_WindowSettingsEditor> {
  ...
  void _updateSatelliteSize() {
    widget.settings.satelliteSize = Size(
      double.tryParse(_satelliteWidthController.text) ?? widget.settings.satelliteSize.width,
      double.tryParse(_satelliteHeightController.text) ?? widget.settings.satelliteSize.height,
    );
  }
