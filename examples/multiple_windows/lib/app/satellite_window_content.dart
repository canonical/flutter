        ...
        child: Column(
          ...
          children: [
            ...
            _buildToggleRow(
              ...
              onChanged: (v) => setState(() => _pressureSensitivity = v ?? false),
            ),
          ],
        ),
      ),
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isSelected ? const Color(0xFF5090D0) : const Color(0xFFE8E8E8),
                borderRadius: BorderRadius.circular(6),
                border: Border.all(
                  color: isSelected ? const Color(0xFF3A70B0) : const Color(0xFFCCCCCC),
                ),
              ),
              child: Icon(
                tool.icon,
                color: isSelected ? const Color(0xFFFFFFFF) : const Color(0xFF555555),
                size: 18,
              ),
            ),
          ),
