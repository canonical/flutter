...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  flutter::FlutterWindowController::GetInstance().CreateFlutterWindow(
      L"Window #1", {640, 480}, flutter::WindowArchetype::regular, std::nullopt,
      std::nullopt);
  flutter::FlutterWindowController::GetInstance().CreateFlutterWindow(
      L"Window #2", {640, 480}, flutter::WindowArchetype::regular, std::nullopt,
      std::nullopt);
